...
def _glue_convert_examples_to_features(
    ...
    batch_encoding = tokenizer.batch_encode_plus(
        [(example.text_a, example.text_b) for example in tqdm(examples)], max_length=max_length, pad_to_max_length=True,
    )
    features = []
...
class SnliProcessor(DataProcessor):
    """Processor for the StanfordNLI data set (GLUE version)."""
