...
class TrainingArguments:
    ...
    **which relate to the training loop itself**.
    ...
    adam_epsilon: float = field(default=1e-12, metadata={"help": "Epsilon for Adam optimizer."})
    ...
    wandb_name: str = field(default="wandb-default", metadata={"help": "The run name display on wandb"})
